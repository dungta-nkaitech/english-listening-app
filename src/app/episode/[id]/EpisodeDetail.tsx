  ...
  return (
    <div className="relative min-h-screen bg-[#fef6e4] text-[#000]">
      <div ref={topDivRef}>
            ...
            {[
              ...
              <button
                ...
                className={`flex-1 text-center py-2 text-sm font-medium transition ${
                  activeTab === tab.key ? "bg-white shadow text-green-700 rounded-t-lg" : "text-gray-500 hover:text-black"
                }`}
              >
                {tab.label}
              </button>
        ...
        {/* Main Content */}
        <div className="absolute left-0 right-0 overflow-y-auto px-4" style={{ top: topDivHeight + 5, bottom: 200 }}>
          ...
          {!loading && !error && activeTab === "vocab" && (
            <VocabularyList episode={episode} userVocabItems={userVocabItems} systemVocabItems={systemVocabItems} />
          )}
        </div>
      </div>
