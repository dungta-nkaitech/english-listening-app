...
export async function POST(req: NextRequest) {
  try {
    ...
    const { userId, word, definition, example, episodeId, episodeTitle } = body;
    console.log("Vocab Body", body);
...
export async function GET(req: NextRequest) {
  try {
    ...
    let query = supabase.from("user_vocab_items").select("id, user_id, episode_id, word, definition, example, created_at, episode_title").eq("user_id", userId);
